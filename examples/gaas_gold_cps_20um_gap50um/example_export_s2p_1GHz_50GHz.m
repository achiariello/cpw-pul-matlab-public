...
% Frequency range: 1 GHz .. 50 GHz (logspace).
% Line length: 1 mm.
% Assumptions:
...
% Export Touchstone
outfile = fullfile(this_dir, 'gaas_gold_cps_diff_2port_1GHz_50GHz.s2p');
...
xlabel('Frequency [Hz]');
ylabel('Magnitude [dB]');
title('Differential CPS S-parameters (1 GHz .. 50 GHz, 1 mm, Z0 = 100 Ohm)');
legend('|S11|', '|S21|', 'Location', 'best');

plotfile = fullfile(this_dir, 'gaas_gold_cps_diff_2port_1GHz_50GHz_plot.png');
