...
% Export Touchstone
outfile = fullfile(this_dir, 'gaas_gold_cps_diff_2port_100kHz_1GHz.s2p');
...
xlabel('Frequency [Hz]');
ylabel('Magnitude [dB]');
title('Differential CPS S-parameters (100 kHz .. 1 GHz, Z0 = 100 Ohm)');
legend('|S11|', '|S21|', 'Location', 'best');

plotfile = fullfile(this_dir, 'gaas_gold_cps_diff_2port_100kHz_1GHz_plot.png');
