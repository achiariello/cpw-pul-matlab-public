...
% Export Touchstone
outfile = fullfile(this_dir, 'gaas_gold_cps_4port_50GHz_100GHz.s4p');
...
xlabel('Frequency [Hz]');
ylabel('Magnitude [dB]');
title('CPS 4-port S-parameters (50 GHz .. 100 GHz, Z0 = 50 Ohm)');
legend('|S11|', '|S13|', '|S24|', '|S33|', 'Location', 'best');

plotfile = fullfile(this_dir, 'gaas_gold_cps_4port_50GHz_100GHz_plot.png');
