...
% Export Touchstone
outfile = fullfile(this_dir, 'gaas_gold_cps_diff_2port_50GHz_100GHz_0p8mm.s2p');
...
xlabel('Frequency [Hz]');
ylabel('Magnitude [dB]');
title('Differential CPS S-parameters (50 GHz .. 100 GHz, 0.8 mm, Z0 = 100 Ohm)');
legend('|S11|', '|S21|', 'Location', 'best');

plotfile = fullfile(this_dir, 'gaas_gold_cps_diff_2port_50GHz_100GHz_0p8mm_plot.png');
