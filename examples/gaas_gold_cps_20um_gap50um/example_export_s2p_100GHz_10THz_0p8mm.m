...
% Frequency range: 100 GHz .. 10 THz (logspace).
% Line length: 0.8 mm.
% Assumptions:
...
% Export Touchstone
outfile = fullfile(this_dir, 'gaas_gold_cps_diff_2port_100GHz_10THz_0p8mm.s2p');
...
xlabel('Frequency [Hz]');
ylabel('Magnitude [dB]');
title('Differential CPS S-parameters (100 GHz .. 10 THz, 0.8 mm, Z0 = 100 Ohm)');
legend('|S11|', '|S21|', 'Location', 'best');

plotfile = fullfile(this_dir, 'gaas_gold_cps_diff_2port_100GHz_10THz_0p8mm_plot.png');
